         ...
         <ul className='tabs-container'>
          {
             tabsList.map(tabDetails => (
                <TabItem updateActiveTabId={this.updateActiveTabId} tabDetails={tabDetails} key={tabDetails.tabId} 
         ...
         <ul className='project-list-container'>
          {
            filteredProjects.map(projectDetails =>(
              <ProjectItem projectDetails={projectDetails} key={projectDetails.projectId} />
            ))
          }
         </ul>
